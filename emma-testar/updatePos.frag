...
void main(void)
{
    ...
    if (age > maxLifetime) {
        float newX = rand(curPos.xyz, vec3(17.975, 88.156, 25.428), -290.0, 290.0);
        float newY = rand(curPos.xyz, vec3(12.989, 78.233, 37.719), 800.0, 4000.0);
        float newZ = rand(curPos.xyz, vec3(39.346, 11.135, 83.155), -290.0, 290.0);
